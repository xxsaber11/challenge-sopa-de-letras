package com.challenge.soup.alphabetSoup;

import org.junit.Before;
import org.junit.Test;

import com.challenge.soup.servicesImpl.WordSearcherServiceImpl;
...
public class WordSearcherTest {
    ...
    private WordSearcherServiceImpl wordSearcherServiceImpl;

    @Before
    public void before() {
        wordSearcherServiceImpl = new WordSearcherServiceImpl(alphabetSoup);
    }

    @Test
    public void testEstaOTW() {
        assertTrue(wordSearcherServiceImpl.isPresent("OTW"));
    }

    @Test
    public void testEstaZapatilla() {
        assertTrue(wordSearcherServiceImpl.isPresent("ZAPATILLA"));
    }
    ...
    public void testEstaCazador() {
        assertTrue(wordSearcherServiceImpl.isPresent("CAZADOR"));
    }

    @Test
    public void testEstaReloj() {
        assertTrue(wordSearcherServiceImpl.isPresent("RELOJ"));
    }

    @Test
    public void testEstaOruga() {
        assertTrue(wordSearcherServiceImpl.isPresent("ORUGA"));
    }

    @Test
    public void testEstaHormonas() {
        assertTrue(wordSearcherServiceImpl.isPresent("HORMONAS"));
    }

    @Test
    public void testEstaCuchilla() {
        assertTrue(wordSearcherServiceImpl.isPresent("CUCHILLA"));
    }
